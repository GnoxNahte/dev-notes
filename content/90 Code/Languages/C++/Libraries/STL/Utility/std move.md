...
> [!NOTE] remove_reference` explanation:
> Using [[90 Code/Languages/C++/Keywords/Templates/Template specialisation\|Template specialisation]], `remove_reference::type` 
...
TLDR:
- Takes the parameter
- Remove any references to prevent [[90 Code/Languages/C++/Features/Advanced/Reference Collapsing]] 
