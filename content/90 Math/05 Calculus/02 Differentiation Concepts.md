...
Now, as $a$ approaches to $x$ (related to [[01 Limits|Limits]]), distance between $x$ and $a$ tends to $0$, this gradient makes it look closer and closer to a tangent to the line. See [Math Is Fun link](https://www.mathsisfun.com/calculus/derivatives-introduction.html)
...
Also known as _critical points_, it's where

- $f$ changes switches between decreasing and increasing.
- which can be found where $f\,'(c)=0$
- or when $f$ is not differentiable at $c$ #todo - _(unsure?)_ Example: $f(x)=|x|$

### Example - Quadratic

Using the [[#Quadratic]] example below,
