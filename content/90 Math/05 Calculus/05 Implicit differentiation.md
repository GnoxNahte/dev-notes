---
publish: true
created: 2026-02-04T14:24:30.516Z
modified: 2026-02-21T07:30:57.141Z
published: 2026-02-21T07:30:57.141Z
tags:
  - todo
---
...
>
> Treat $y$ as an expression, so splitting it using [[03 Differentiation Formulas#Composite Functions|Chain Rule]], $\frac{d}{dx}y^2$ can be separated into
>
> - Outer function: $\frac{d}{dx}(\dots)^2=2(\dots)$
> - Inner function: $\frac{d}{dx}y=\frac{dy}{dx}$
>
> Combining using [[03 Differentiation Formulas#Composite Functions|Chain Rule]] - $\frac{d}{dx}f(g(x))=f\,'(g(x))g\,'(x)$,
>
> $$
> \begin{align}
...
Using the [[#Example|previous answer]], $\frac{dy}{dx}=-\frac{x}{y}$
