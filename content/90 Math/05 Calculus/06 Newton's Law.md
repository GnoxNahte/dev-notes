---
publish: true
created: 2026-03-20T02:08:45.339Z
modified: 2026-04-08T14:03:03.199Z
published: 2026-04-08T14:03:03.199Z
---
...
1. Pick an [[Functions - f(x)#Terminology - Intervals|interval/domain]]
2. [[#Check if there's a root - Intermediate Value Theorem (IVT)|Check if there's a root]]
3. Use [[#Newton's Method]] to find an approximate root
...
- To check for this, if $f(a) \cdot f(b) < 0$, the roots exists
  - _However, this doesn't mean that the root exists_ if the result is $> 0$. See [[#Example 2 - WARNING Test Limitation|example]] below
...
This is a _approximation_! The accuracy of it increases with more iterations.

See [[#Newton's Method derivation]]
...
From [[02 Differentiation Concepts#Second definition|Differentiation's Definition]],
...
When $a$ is _close_ to $x$, (Definition of [[01 Limits|Limits]])
