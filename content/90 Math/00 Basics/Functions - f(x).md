...
- [[2. Matrix and Linear Transformation|Matrix transformations]] - Functions for points/vectors
...
NOTE: Since $fh(x)$ gives x, it means that $f(x)$ and $g(x)$ are [[#Inverse Functions]]. See [[#Inverse Function#Example|Inverse Function Example]].
...
> See [[#Inverse Function Example (When **cannot** inverse)|Example below]]
...
For example,
Multiplying a function with it's [[#Inverse Function]] - $(f \circ f^{-1})(x)$  results in $x$
